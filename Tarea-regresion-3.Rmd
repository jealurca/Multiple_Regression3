...
#title: Tarea Examen \\ Regresión lineal
authot:
...
A continuación, se realiza la prueba de **significancia conjunta**. REVISAR LA PP62 notas de CLau. 
...
\begin{thebibliography}{99}
  \bibitem{Faraway}
      Faraway, J. J.,
      \emph{Extending the linear model with R: generalized linear, mixed effects and nonparametric regression models},
      CRC press.
      (2016) 
  ...
  \bibitem{oms20}
  OMS,
  \emph{COVID-19: cronología de la actuación de la OMS},
  obtenido el 20 de noviembre de 2020 desde
